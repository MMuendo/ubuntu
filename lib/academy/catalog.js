export const ubuntuCourses = [
  {
    ...
    summary:
      "Use Excel to structure local business problems, model decisions, and communicate insight clearly.",
  ...
  },
  {
    ...
    summary:
      "Turn operational data into decision-ready dashboards and reporting systems leaders can actually use.",
    oldPriceKes: 20000,
  ...
  },
  {
    ...
    instructorTitle: "Senior Data Scientist and AI Engineer",
    summary:
      "Build AI Solutions with ChatGPT, Claude, Claude Code, DeepSeek & n8n",
    heroSubtitle:
      "A practical 5-week masterclass designed to help learners understand AI, master prompting, build AI automations, create AI agents, and deploy real-world solutions using modern AI tools.",
    modules: ["What an AI agent is and how agentic systems work", "Meeting your workbench: n8n, ChatGPT, and Claude Code", "Giving your AI hands with tools, APIs, and webhooks", "Knowledge, RAG, personality, memory, and context with Claude Code", "WhatsApp agents, web integration, customer service desks, and safety"],
    journeySchedule: [
      {
        theme: "MODULE 1: Understanding AI & Prompt Engineering",
        sessions: [
          {
            week: "1",
            lesson: "1",
            date: "Tue, 4 Aug",
            time: "7:00-8:30 PM",
            title: "Understanding AI, LLMs & AI Agents",
            description:
              "What You Will Learn\n- What Artificial Intelligence (AI) really is\n- Understanding LLMs (Large Language Models)\n- ChatGPT vs Claude vs DeepSeek\n- What makes an AI Agent different from a chatbot\n- African business use cases for AI\n\nOutcome\nUnderstand the AI landscape and identify opportunities to apply AI in your work or business."
          },
          {
            week: "1",
            lesson: "2",
            ...
            description:
              "What You Will Learn\n- Principles of effective prompting\n- Role prompting and instruction design\n- Chain-of-thought and reasoning prompts\n- Context engineering for better outputs\n- Creating reusable prompt templates\n\nOutcome\nGenerate higher-quality AI outputs consistently across multiple use cases."
          }
        ]
      },
      {
        theme: "MODULE 2: AI Tools for Builders",
        sessions: [
          {
            week: "2",
            lesson: "3",
          ...
          },
          {
            ...
            description:
              "What You Will Learn\n- Introduction to Claude Code\n- Building applications with AI assistance\n- Understanding existing codebases\n- Debugging and improving code using AI\n- Accelerating development workflows\n\nOutcome\nUse AI to build faster, solve technical problems, and increase productivity."
          }
        ]
      },
      {
        theme: "MODULE 3: Automation & Workflows",
        sessions: [
          {
            week: "3",
            lesson: "5",
            date: "Tue, 18 Aug",
            time: "7:00-8:30 PM",
            title: "Building Automations with n8n",
            description:
          ...
          },
          {
            ...
            date: "Thu, 20 Aug",
            time: "7:00-8:30 PM",
            title: "APIs, Webhooks & AI Integrations",
            description:
              "What You Will Learn\n- What APIs are and how they work\n- Understanding webhooks\n- Connecting AI models to external systems\n- Sending and receiving data between tools\n- Building integrated AI workflows\n\nOutcome\nConnect AI systems to real business applications."
          }
        ]
      },
      {
        theme: "MODULE 4: Building AI Agents",
        sessions: [
          {
            week: "4",
            lesson: "7",
            ...
            description:
              "What You Will Learn\n- Agent architecture fundamentals\n- Memory and context management\n- Tool use and function calling\n- Multi-step reasoning\n- Agent design best practices\n\nOutcome\nBuild a functioning AI agent capable of completing tasks."
          },
          {
            week: "4",
            lesson: "8",
            date: "Thu, 27 Aug",
            time: "7:00-8:30 PM",
            title: "RAG & Knowledge-Based AI Agents",
            description:
              "What You Will Learn\n- Introduction to Retrieval-Augmented Generation (RAG)\n- Working with documents and knowledge bases\n- Creating searchable AI assistants\n- Improving response accuracy\n- Building internal knowledge agents\n\nOutcome\nCreate AI systems that answer questions using your own data."
          }
        ]
      },
      {
        theme: "MODULE 5: Deploying Real-World AI Solutions",
        sessions: [
          {
            week: "5",
            lesson: "9",
            date: "Tue, 1 Sep",
            time: "7:00-8:30 PM",
            title: "WhatsApp AI Agents for Business",
            description:
              "What You Will Learn\n- WhatsApp business automation\n- Customer support AI assistants\n- Lead qualification agents\n- Appointment and enquiry handling\n- Integrating WhatsApp with AI workflows\n\nOutcome\nDeploy AI solutions where customers already are."
          },
          {
            week: "5",
            lesson: "10",
            ...
            description:
              "What You Will Learn\n- Designing a complete AI solution\n- Building an end-to-end workflow\n- Testing and optimization\n- Deployment strategies\n- Presenting your project\n\nOutcome\nLaunch a real AI-powered solution for work, business, or clients."
          }
        ]
      }
    ],
  ...
  },
  {
    ...
    instructor: "Jacktone Etemesi",
    instructorTitle: "Senior Data Scientist",
    summary: "Use Python to clean real-world data, answer business questions, and produce project-ready analysis.",
  ...
  },
  {
    ...
    instructor: "Jacktone Etemesi",
    instructorTitle: "Senior Data Scientist",
    summary: "Query business data, join tables, and prepare datasets for dashboards and reports.",
  ...
  },
  {
    ...
    instructorTitle: "Senior Data Scientist and AI Engineer",
    summary:
      "Read reports, question data, use AI safely, and turn workplace information into decisions.",
    modules: ["Data and AI fluency for business leaders", "Reports, dashboards, and KPI definitions", "Prompt engineering for sharper business questions", "Data quality traps and AI output stress-testing", "Decision storytelling, business cases, and human > AI > human workflows"],
    journeySchedule: [
      {
        ...
        sessions: [
          {
            ...
            description: "Understand what numbers mean, what changed, what needs attention, and what not to trust blindly."
          },
          {
            week: "1",
            lesson: "2",
    ...
    outcomes: ["Read reports with confidence: learn what to trust, what to question, and how to spot misleading data.", "Ask sharper questions: stop accepting summaries at face value and structure inquiry so you get the data you actually need.", "Turn data and AI outputs into decisions: transform numbers into business cases and persuade others to act on them.", "Build skills across Excel, dashboards, and AI assistants by understanding the thinking behind each tool.", "Explain what AI can and cannot do in business without overselling it.", "Compare ChatGPT, Claude, Gemini, and other AI assistants for real workplace tasks.", "Use AI to summarize, challenge, and explain data without outsourcing judgment.", "Design human > AI > human review workflows that protect sensitive data and improve decisions."],
    tools: ["Excel", "Dashboards", "ChatGPT", "Claude", "Gemini", "Reports", "Scorecards"],
    projects: ["Project 1: The Audit - Spot 5 quality issues in a broken dashboard and propose fixes.", "Project 2: The Scenario Model - Build a 3-scenario Excel model and brief leadership on trade-offs.", "Project 3: The AI Extraction - Use AI to extract patterns from unstructured data, then validate and frame the limitations.", "Project 4: The Business Case - Gather data, structure an argument, and persuade stakeholders to act.", "Project 5: The Diagnosis - Decompose a metric drop, identify root causes, and recommend next steps.", "Project 6: The AI Strategy Memo - Identify one useful AI workflow, its risks, and the human review needed before rollout."],
    roles: ["Executive", "Manager", "Operations manager", "Sales lead", "Finance assistant", "Program officer", "Any Leadership Role", "Business Intelligence Analyst"],
    demand: ["SMEs", "NGOs", "Operations", "Customer support", "Leadership", "Business teams", "Analytics consumers"]
  }
];
...
export const projectTracks = [
  {
    ...
    summary: "Spreadsheet projects using familiar Kenyan and East African business contexts.",
    accent: "#2563eb",
    projects: [
      {
  ...
  },
  {
    id: "powerbi",
    title: "Business Analytics with Power BI",
    summary: "BI projects that turn operational data into management reports for local teams.",
    accent: "#7c3aed",
    projects: [
      {
  ...
  },
  {
    ...
    summary: "Automation projects for builders moving from prompts into useful systems.",
    accent: "#ea580c",
    projects: [
      {
...
export const dataAssessmentQuestions = [
  ...
  },
  {
    ...
    text: "Flag accounts where NPL ratio exceeds 15% and loan balance is above KES 500,000. Which function combines both tests?",
  ...
  },
  {
    ...
    category: "powerbi",
    topic: "Measures",
    text: "Why is Profit Margin % usually a measure?",
...
export function recommendationForAssessment(path, answers) {
  ...
  if (path === "ai") {
    const courseSlug = score >= 70 ? "ai-agents-masterclass" : "data-fluency-for-operators-and-managers";
    return {
      score,
