export const ubuntuCourses = [
  {
    slug: "working-with-data-for-professionals",
    title: "Working with Data for Professionals",
    category: "Business",
    courseType: "course",
    level: "Foundation",
    duration: "6 weeks",
    ...
    modules: ["Data confidence", "Spreadsheet thinking", "Dashboard reading", "AI-assisted analysis", "Decision communication"],
    outcomes: ["Read reports with confidence", "Ask sharper business questions", "Turn data and AI outputs into decisions"],
    tools: ["Excel", "Dashboards", "AI assistants", "Reports"],
    projects: ["Weekly business scorecard", "Insight memo", "Dashboard interpretation exercise"],
    roles: ["Manager", "Operations lead", "Finance officer", "Program officer"],
    demand: ["SMEs", "NGOs", "Operations", "Leadership"]
  },
  {
    slug: "excel-workshop",
    ...
    modules: ["Excel structure", "Formulas and logic", "Pivot tables", "Scenario analysis", "Dashboard storytelling"],
    outcomes: ["Build reliable workbooks", "Read business data with confidence", "Create board-ready Excel dashboards"],
    tools: ["Excel", "Power Query", "PivotTables", "CSV"],
    projects: ["Safaricom Subscriber Tracker", "M-Pesa Revenue Analyser", "KCB Loan Portfolio Analyser"],
    roles: ["Operations analyst", "Finance assistant", "Business analyst"],
    demand: ["SMEs", "Banking", "Telecom", "Retail"]
  },
  {
    ...
    modules: ["Power Query", "Star schema models", "DAX measures", "Report design", "Refresh and sharing"],
    outcomes: ["Model clean BI data", "Build executive dashboards", "Explain trends and KPI movement"],
    tools: ["Power BI", "DAX", "Power Query", "Excel"],
    projects: ["Retail Sales Performance Report", "Financial P&L Dashboard", "Logistics KPI Tracker"],
    roles: ["BI analyst", "Reporting analyst", "Operations analyst"],
    demand: ["Finance", "Logistics", "Retail", "Operations"]
  },
  {
    slug: "ai-mastery",
    ...
    modules: ["AI fundamentals", "Prompting for business", "Tool selection", "AI risk", "Decision workflows"],
    outcomes: ["Lead AI conversations", "Use AI without exposing sensitive data", "Turn AI outputs into usable decisions"],
    tools: ["AI assistants", "Prompt frameworks", "Reports", "Spreadsheets"],
    projects: ["AI Tools Audit", "Prompt Engineering Workbook", "AI Strategy Memo"],
    roles: ["Manager", "Analyst", "Founder", "Team lead"],
    demand: ["SMEs", "NGOs", "Analytics teams", "Operations"]
  },
  {
    ...
    modules: ["Agent design", "n8n workflows", "Webhooks and APIs", "Memory and tools", "Human review"],
    outcomes: ["Design workflow agents", "Connect AI to business systems", "Build guardrails for automation"],
    tools: ["n8n", "OpenAI", "Webhooks", "APIs", "JSON"],
    projects: ["Lead Qualification Agent", "Document Summarisation Pipeline", "Multi-Agent Research Assistant"],
    roles: ["AI builder", "Automation analyst", "Data product builder"],
    demand: ["Sales ops", "Customer support", "Finance", "Research"]
  },
  {
  ...
  },
  {
    ...
    outcomes: ["Read dashboards with confidence", "Spot weak metrics and quality issues", "Turn reports into practical next steps"],
    tools: ["Excel", "Dashboards", "AI assistants", "Reports"],
