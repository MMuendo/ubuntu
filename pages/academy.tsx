...
const projectTracks: Track[] = [
  ...
  },
  {
    ...
    projects: [
      ...
      { id: 'pbi-04', title: 'Ubuntu AnalytIQ: Customer Segmentation Report', company: 'CRM Dataset', companyTag: 'Kenyan Market', lessonsCovered: 'Lessons 13–16', level: 'Advanced', estimatedTime: '7–9 hrs', description: 'Use RFM analysis to segment customers and build a churn risk dashboard with cohort analysis.', skills: ['Complex DAX','RFM Modeling','Cohort Analysis','What-If Parameters'], learningOutcome: 'Master complex DAX, build RFM segmentation logic, and deliver a churn-risk dashboard executives trust.', dataSource: 'Fictional CRM dataset', datasetFile: 'pbi-04-crm-dataset.xlsx', taskFile: 'pbi-04-crm-task.pdf' },
    ],
  },
  {
...
const AcademyPage: React.FC = () => {
  ...
  const s1 = useCountUp(500, 2000, statsVisible);
