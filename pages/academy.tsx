...
const projectTracks: Track[] = [
    ...
    projects: [
      {
        ...
        learningOutcome:
          'You will confidently navigate Excel, structure real business data, write your first formulas, and produce a chart-ready subscriber report.',
        dataSource: 'Safaricom Annual Report FY2024 (publicly available at safaricom.co.ke)',
      ...
      },
      {
        ...
        learningOutcome:
          'You will move beyond basic Excel — writing logic-driven formulas, building lookup models, and producing a multi-series chart dashboard from real fintech data.',
      ...
      },
      {
        ...
        learningOutcome:
          'You will master pivot tables — the single most powerful Excel skill for analysts — and learn to lock down your work for professional delivery.',
      ...
      },
      {
        ...
        learningOutcome:
          'You will write formulas that analysts use daily, build self-updating models with dynamic arrays, and create an interactive pivot dashboard executives can slice by country.',
      ...
      },
      {
        ...
        companyTag: 'NSE: KQ',
        description:
          "Kenya Airways reports passenger revenue and load factors by route segment. Build a fully dynamic dashboard that uses Scenario Manager to model fuel-cost shocks, Goal Seek to find the break-even load factor per route, and a VBA button that refreshes and formats the report in one click — a complete analyst-grade deliverable.",
        ...
        learningOutcome:
          'Your capstone project. You will build a board-ready dashboard that auto-refreshes, models financial scenarios, and runs VBA scripts — the full advanced Excel toolkit.',
  ...
  },
  {
    ...
    projects: [
      {
        id: 'pbi-01',
        title: 'Ubuntu AnalytIQ: Retail Sales Performance Report',
        company: 'Retail Dataset', companyTag: 'Kenyan Market',
        ...
        lessonsCovered: 'Lessons 1–4', level: 'Beginner', estimatedTime: '4–5 hrs',
        skills: ['Power Query', 'Star Schema', 'Basic DAX', 'Date Tables', 'Bar Charts'],
        learningOutcome: 'Load and shape data in Power Query, build your first star schema, and produce a clean executive report.',
        dataSource: 'Fictional Kenyan retail dataset',
        datasetFile: 'pbi-01-retail-dataset.xlsx', taskFile: 'pbi-01-retail-task.pdf',
      },
      {
        id: 'pbi-02',
        title: 'Ubuntu AnalytIQ: Financial P&L Dashboard',
        company: 'Finance Dataset', companyTag: 'Kenyan Market',
        ...
        lessonsCovered: 'Lessons 5–8', level: 'Intermediate', estimatedTime: '5–7 hrs',
        skills: ['DAX Time Intelligence', 'Drill-Through', 'Bookmarks', 'Dynamic Titles'],
        learningOutcome: 'Write time intelligence DAX, build drill-through navigation, and deliver a finance-grade P&L report.',
        dataSource: 'Fictional P&L dataset',
        datasetFile: 'pbi-02-finance-dataset.xlsx', taskFile: 'pbi-02-finance-task.pdf',
      },
      {
        id: 'pbi-03',
        title: 'Ubuntu AnalytIQ: Logistics KPI Tracker',
        company: 'Logistics Dataset', companyTag: 'Kenyan Market',
        description: 'Track on-time delivery rates, route efficiency, and driver performance across regions.',
        lessonsCovered: 'Lessons 9–12', level: 'Intermediate', estimatedTime: '5–6 hrs',
        skills: ['Calculated Columns', 'Row-Level Security', 'Maps', 'KPI Visuals'],
        learningOutcome: 'Build a map-enabled operations dashboard with RLS and KPI card visuals.',
        dataSource: 'Fictional logistics dataset',
        datasetFile: 'pbi-03-logistics-dataset.xlsx', taskFile: 'pbi-03-logistics-task.pdf',
      },
      {
        id: 'pbi-04',
        title: 'Ubuntu AnalytIQ: Customer Segmentation Report',
        company: 'CRM Dataset', companyTag: 'Kenyan Market',
        description: 'Use RFM analysis to segment customers and build a churn risk dashboard with cohort analysis.',
        lessonsCovered: 'Lessons 13–16', level: 'Advanced', estimatedTime: '7–9 hrs',
        skills: ['Complex DAX', 'RFM Modeling', 'Cohort Analysis', 'What-If Parameters'],
        learningOutcome: 'Master complex DAX, build RFM segmentation logic, and deliver a churn-risk dashboard executives trust.',
        dataSource: 'Fictional CRM dataset',
        datasetFile: 'pbi-04-crm-dataset.xlsx', taskFile: 'pbi-04-crm-task.pdf',
      },
    ],
  },
  {
    ...
    projects: [
      {
        id: 'ai-01', title: 'Ubuntu AnalytIQ: AI Tools Audit for Your Role',
        company: 'Your Organisation', companyTag: 'Any Industry',
        description: 'Map 10 AI tools relevant to your job function, evaluate their capabilities, risks, and ROI.',
        lessonsCovered: 'Module 1–2', level: 'Beginner', estimatedTime: '2–3 hrs',
        skills: ['AI Tool Evaluation', 'Business Framing', 'ROI Analysis', 'Risk Assessment'],
        learningOutcome: 'You will have a clear map of AI tools for your role and a framework for evaluating any new tool.',
        dataSource: 'No dataset required', datasetFile: null, taskFile: 'ai-01-tools-audit-task.pdf',
      },
      {
        id: 'ai-02', title: 'Ubuntu AnalytIQ: Prompt Engineering Workbook',
        company: 'Cross-Industry', companyTag: 'Any Role',
        description: 'Complete 15 structured prompting challenges across marketing, finance, HR, and operations.',
        lessonsCovered: 'Module 3–4', level: 'Beginner', estimatedTime: '3–4 hrs',
        skills: ['Prompt Engineering', 'Chain-of-Thought', 'Role Prompting', 'Output Structuring'],
        learningOutcome: 'You will write prompts that get consistent, professional-grade AI outputs for real business tasks.',
        dataSource: 'No dataset required', datasetFile: null, taskFile: 'ai-02-prompt-workbook-task.pdf',
      },
      {
        id: 'ai-03', title: 'Ubuntu AnalytIQ: AI Strategy Memo',
        company: 'Fictional EA Company', companyTag: 'East Africa',
        description: 'Write a 2-page AI adoption strategy memo for a fictional East African company.',
        lessonsCovered: 'Module 5–6', level: 'Intermediate', estimatedTime: '4–5 hrs',
        skills: ['Strategic Thinking', 'AI Ethics', 'Business Writing', 'Use Case Design'],
        learningOutcome: 'You will confidently advise leadership on AI adoption — the skill that separates AI-fluent professionals from the rest.',
        dataSource: 'No dataset required', datasetFile: null, taskFile: 'ai-03-strategy-memo-task.pdf',
      },
    ],
  },
  {
    ...
    projects: [
      {
        id: 'ag-01', title: 'Ubuntu AnalytIQ: Lead Qualification Agent',
        company: 'n8n + OpenAI', companyTag: 'Automation',
        description: 'Build an n8n workflow that captures leads, scores them using AI, and routes qualified leads to a CRM via webhook.',
        lessonsCovered: 'Module 1–2', level: 'Intermediate', estimatedTime: '4–6 hrs',
        skills: ['n8n Workflows', 'Webhooks', 'OpenAI API', 'CRM Integration'],
        learningOutcome: 'You will ship a working AI agent that automates a real sales process end-to-end.',
        dataSource: 'No dataset required', datasetFile: null, taskFile: 'ag-01-lead-agent-task.pdf',
      },
      {
        id: 'ag-02', title: 'Ubuntu AnalytIQ: Document Summarisation Pipeline',
        company: 'LangChain + Email', companyTag: 'Automation',
        ...
        lessonsCovered: 'Module 3–4', level: 'Intermediate', estimatedTime: '5–7 hrs',
        skills: ['LangChain', 'PDF Parsing', 'Email Automation', 'Prompt Chaining'],
        learningOutcome: 'Build a document intelligence pipeline that saves hours of manual reading every week.',
        dataSource: 'Sample PDF documents provided',
        datasetFile: 'ag-02-sample-docs.zip', taskFile: 'ag-02-doc-pipeline-task.pdf',
      },
      {
        id: 'ag-03', title: 'Ubuntu AnalytIQ: Multi-Agent Research Assistant',
        company: 'CrewAI', companyTag: 'Agentic Systems',
        description: 'Design a CrewAI system with a researcher, analyst, and writer agent that produces business reports autonomously.',
        lessonsCovered: 'Module 5–6', level: 'Advanced', estimatedTime: '7–9 hrs',
        skills: ['CrewAI', 'Agent Roles & Tools', 'Task Chaining', 'Output Formatting'],
        learningOutcome: 'Orchestrate multiple AI agents working together — one of the most in-demand skills in enterprise AI.',
        dataSource: 'No dataset required', datasetFile: null, taskFile: 'ag-03-multiagent-task.pdf',
      },
      {
        id: 'ag-04', title: 'Ubuntu AnalytIQ: Customer Support Bot',
        company: 'OpenAI Assistants', companyTag: 'Deployment',
        ...
        lessonsCovered: 'Module 7–8', level: 'Advanced', estimatedTime: '8–10 hrs',
        skills: ['OpenAI Assistants API', 'RAG', 'Memory & Context', 'Bot Deployment'],
        learningOutcome: 'A fully deployed, production-ready AI support agent with retrieval-augmented generation.',
        dataSource: 'Sample knowledge base provided',
        datasetFile: 'ag-04-knowledge-base.zip', taskFile: 'ag-04-support-bot-task.pdf',
      },
    ],
  },
];
...
const AcademyPage: React.FC = () => {
  ...
  const handleDownload = (fileName: string | null) => {
    ...
    window.open(`https://your-supabase-url.supabase.co/storage/v1/object/public/projects/${fileName}`, '_blank');
  };
    ...
    <div className="bg-[#18100F] min-h-screen">
      ...
      <section id="courses" className="py-20 bg-[#18100F]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-white via-gray-100 to-gray-400 bg-clip-text text-transparent px-4">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
              {enhancedCourses.map((course) => {
                ...
                return (
                  <div key={course.id}
                    className={`bg-gradient-to-br ${course.gradient} bg-gray-900/40 border border-white/10 rounded-2xl p-5 md:p-6 flex flex-col ${course.hoverBorder} hover:shadow-lg ${course.hoverShadow} transition-all duration-300 group relative overflow-hidden`}>
                    <div className="relative z-10">
                      <div className="mb-4 flex items-center justify-between">
                        <span className={`text-xs font-bold ${course.accent} uppercase tracking-wider bg-white/5 px-3 py-1.5 rounded-lg border border-white/10`}>
                          {course.level}
                        </span>
                      ...
                      <div className="mb-6 space-y-2.5">
                        ...
                        {course.includes.map((item, i) => (
                          <div key={i} className="flex items-start gap-2">
                            <CheckCircle2 className={`w-4 h-4 ${course.accent} mt-0.5 flex-shrink-0`} />
                      ...
                      <Link to={`/course/${course.id}`}
                        className={`w-full bg-white/5 ${course.accent} border border-white/10 ${course.hoverBorder} hover:bg-white/10 rounded-lg px-4 py-3 text-sm font-semibold flex items-center justify-center gap-2 transition-all duration-300 group/btn`}>
      ...
      <section id="webinars" className="py-20 bg-[#18100F] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-white via-purple-100 to-purple-400 bg-clip-text text-transparent px-4">
              Learn Before You Commit
            </h2>
            <p className="text-lg text-gray-400 max-w-2xl mx-auto px-4">
              Join our free webinars to explore data analytics and AI before enrolling.
            </p>
          </div>

          {/* LEFT→RIGHT scroll, no reverse, right-edge fade indicator */}
          <div className="relative">
            <div className="flex gap-5 overflow-x-auto pb-4 scrollbar-hide snap-x snap-mandatory">
              {webinars.map((w) => (
                <div key={w.id} className="snap-start">
                  <WebinarCard webinar={{ ...w, status: 'completed' }} />
                </div>
              ))}
            </div>
      ...
      <section id="projects" className="py-20 bg-[#18100F] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-block mb-4">
              <span className="text-orange-400 text-sm font-semibold tracking-wider uppercase bg-orange-500/10 px-4 py-2 rounded-full border border-orange-500/20">
                Hands-On Projects
              </span>
            </div>
            <h2 className="text-3xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-white via-orange-100 to-orange-400 bg-clip-text text-transparent px-4">
              Practice What You Learn
            </h2>
            <p className="text-lg text-gray-400 max-w-2xl mx-auto px-4">
              Real-world projects using data from Kenyan companies. Each project is standalone — start anywhere.
            </p>
          </div>
          ...
          <div className="relative mb-10">
              ...
              {projectTracks.map((track) => {
                ...
                return (
                  <button key={track.id} onClick={() => setActiveTrack(track.id)}
                    ...
                    <Icon className={`w-5 h-5 ${isActive ? track.accentColor : 'text-gray-400'}`} />
                    {/* Full label always visible, wraps naturally */}
            ...
            {/* Right fade so user knows it scrolls */}
          ...
          <div className={`mb-8 p-5 rounded-2xl border ${currentTrack.borderColor} ${currentTrack.bgColor} flex items-center gap-4`}>
            <div className={`w-12 h-12 rounded-xl ${currentTrack.bgColor} border ${currentTrack.borderColor} flex items-center justify-center flex-shrink-0`}>
              {(() => { const TI = currentTrack.icon; return <TI className={`w-6 h-6 ${currentTrack.accentColor}`} />; })()}
            </div>
            <div>
              <h3 className="text-lg font-bold text-white">{currentTrack.title}</h3>
              <p className="text-sm text-gray-400">
                {currentTrack.projects.length} standalone projects — start with any level
              </p>
            </div>
          </div>
              ...
              return (
                <div key={project.id}
                  ...
                  <div className="relative z-10 flex flex-col gap-5">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {project.skills.map((skill) => (
                          <span key={skill}
                            className="text-xs text-gray-300 bg-white/5 border border-white/10 px-3 py-1.5 rounded-lg">
                            {skill}
                          </span>
                        ))}
                      </div>
                    ...
                    {/* ── Actions — visually distinct download vs submit ── */}
                    {isLoggedIn ? (
                      <div className="flex flex-col gap-3 pt-4 border-t border-white/5">
                        {/* Download row — tinted accent buttons */}
                        ...
                        {/* Submit — white/ghost so it reads as a separate action */}
                        <label className={`w-full flex items-center justify-center gap-2 py-3.5 px-4 rounded-xl text-sm font-semibold border cursor-pointer transition-all ${
                          ...
                          {didUpload
                            ...
                            : isUploading
                            ? <><div className="w-4 h-4 border-2 border-gray-500 border-t-transparent rounded-full animate-spin" />Uploading...</>
          ...
          <div className="bg-gradient-to-br from-cyan-500/10 via-purple-500/5 to-cyan-500/10 border border-cyan-500/20 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
                Join hundreds of professionals already on their journey with Ubuntu Academy.
              </p>
