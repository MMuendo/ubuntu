            ...
            <div className="bg-gradient-to-br from-gray-900/60 to-black/40 border border-white/10 rounded-3xl p-8 md:p-12 relative overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <div className="space-y-4 text-gray-300 leading-relaxed text-base md:text-lg max-w-4xl mx-auto">
                  <p>Ubuntu Academy was born from a simple truth: <span className="text-cyan-400 font-semibold">the future belongs to those who can think with data and act with AI.</span></p>
                  ...
                  <p>So we built something different. A practice that blends <span className="text-cyan-400 font-semibold">analytics consulting, capability development, and intelligent automation</span> — designed not to create dependency, but to build self-sufficient, AI-fluent organizations.</p>
                  <p className="text-white font-medium pt-4 border-t border-white/10">From Excel to Agentic AI, we meet you where you are and take you where you need to be.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-cyan-500/5 to-blue-500/5 border border-white/5 rounded-2xl p-8 hover:border-cyan-400/30 transition-all group relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-400">Turn raw data into confident decisions. We transform messy data into clear insights through analysis, modeling, dashboards, storytelling, research, and actionable recommendations for growth, efficiency, and profitability.</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-500/5 to-pink-500/5 border border-white/5 rounded-2xl p-8 hover:border-purple-400/30 transition-all group relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-400">Build analytics and AI skills that deliver results. We offer hands-on training and mentorship for individuals and teams in Business Analytics, Data Science, AI & Agentic AI, and analytics leadership.</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-500/5 to-indigo-500/5 border border-white/5 rounded-2xl p-8 hover:border-blue-400/30 transition-all group relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-400">AI that works for Africa, not just in theory. We build real AI systems and workflows for African SMEs, including agentic AI automation, AI-powered workflows, and productivity systems tailored to Africa.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-[#18100F] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">Blending technical rigor with strategic foresight to deliver measurable impact.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-gray-900/40 to-black/20 border border-white/5 rounded-2xl p-6 relative group overflow-hidden hover:border-brand-cyan/30 transition-all duration-300">
              <div className="absolute -right-10 -top-10 w-32 h-32 bg-brand-cyan/10 rounded-full blur-2xl group-hover:bg-brand-cyan/20 transition-all pointer-events-none" />
              <div className="h-40 flex items-center justify-center mb-6 relative">
                <div className="relative w-24 h-24">
                  ...
                  <div className="absolute inset-2 border-2 border-brand-purple/30 rounded-full animate-[spin_7s_linear_infinite_reverse]" />
                  <div className="absolute inset-0 flex items-center justify-center">
                    <Database className="text-brand-cyan w-10 h-10 animate-pulse" />
                  </div>
                  <div className="absolute top-0 left-1/2 w-2 h-2 bg-brand-cyan rounded-full animate-bounce" />
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-gray-900/40 to-black/20 border border-white/5 rounded-2xl p-6 relative group overflow-hidden hover:border-brand-purple/30 transition-all duration-300">
              <div className="absolute -left-10 -bottom-10 w-32 h-32 bg-brand-purple/10 rounded-full blur-2xl group-hover:bg-brand-purple/20 transition-all pointer-events-none" />
              <div className="h-40 flex items-center justify-center mb-6">
                <div className="relative">
                  <Share2 className="w-20 h-20 text-brand-purple/40" />
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-3 h-3 bg-brand-purple rounded-full shadow-[0_0_15px_#8B5CF6] animate-pulse" />
                  </div>
                </div>
              </div>
              <h3 className="text-xl font-bold text-white mb-2">Skills & Capability Development</h3>
            ...
            <div className="bg-gradient-to-br from-gray-900/40 to-black/20 border border-white/5 rounded-2xl p-6 relative group overflow-hidden hover:border-brand-blue/30 transition-all duration-300">
              <div className="absolute right-0 bottom-0 w-32 h-32 bg-brand-blue/10 rounded-full blur-2xl group-hover:bg-brand-blue/20 transition-all pointer-events-none" />
              <div className="h-40 flex items-center justify-center mb-6">
                <div className="relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-3 h-3 bg-brand-blue rounded-full shadow-[0_0_15px_#3B82F6] animate-pulse" />
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {enhancedCourses.map((course) => {
              ...
              return (
                <div key={course.id}
                  className={`bg-gradient-to-br ${course.gradient} bg-gray-900/40 border border-white/10 rounded-2xl p-5 md:p-6 flex flex-col hover:border-white/20 hover:shadow-lg transition-all duration-300 group`}>
                  <div className="mb-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <CourseIcon className={`w-5 h-5 ${course.accentColor}`} />
                  ...
                  <button
                    ...
                    className={`w-full bg-white/5 ${course.accentColor} border border-white/10 hover:bg-white/10 rounded-lg px-4 py-3 text-sm font-semibold flex items-center justify-center gap-2 transition-all duration-300 group/btn`}>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-cyan-500/10 via-purple-500/5 to-cyan-500/10 border border-cyan-500/20 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-400 mb-8 max-w-2xl mx-auto">Chat with our Ubuntu AI Academy Assistant for instant answers about courses, pricing, and enrollment.</p>
              <button
      ...
      <section className="py-20 bg-[#18100F] relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">What Our Clients Say</h3>
            <p className="text-gray-400 max-w-2xl mx-auto">Real results from professionals who transformed with us</p>
          </div>
            ...
            {testimonials.map((testimonial, index) => (
              <div key={index}
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-cyan-500/10 flex items-center justify-center text-cyan-400 font-bold flex-shrink-0">
                    {testimonial.avatar}
                  </div>
                  <div>
