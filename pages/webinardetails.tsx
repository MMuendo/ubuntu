    ...
    <div className="bg-[#18100F] min-h-screen">
      ...
      <section className="py-20 bg-gradient-to-b from-purple-900/10 to-[#18100F]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400">
              Here's how we'll spend our 90 minutes together
            </p>
          </div>
          ...
          <div className="space-y-4">
            {agenda.map((item, index) => (
              <div
                key={index}
                className="bg-gradient-to-br from-gray-900/60 to-black/40 border border-white/10 rounded-xl p-6 hover:border-purple-500/30 transition-all duration-300"
              >
                <div className="flex flex-col md:flex-row md:items-center gap-4">
                  <div className="md:w-32 flex-shrink-0">
                    <span className="inline-block bg-purple-500/10 text-purple-400 px-4 py-2 rounded-lg font-semibold">
                      {item.time}
                    </span>
                  </div>
      ...
      <section className="py-20 bg-[#18100F]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 p-6 bg-gradient-to-r from-purple-500/10 to-cyan-500/10 border border-purple-500/20 rounded-2xl">
            <div className="flex items-start gap-4">
              <Sparkles className="w-6 h-6 text-purple-400 mt-1 flex-shrink-0" />
              <div>
                <h3 className="text-xl font-bold text-white mb-2">Special Bonus!</h3>
                <p className="text-gray-300">
                  All attendees receive an <span className="text-purple-400 font-semibold">exclusive 10% discount code</span> valid 
                  for any Ubuntu Academy course. Plus, you might even figure out how to automate that one task you've been 
                  secretly dreading! 😄
                </p>
              </div>
            </div>
